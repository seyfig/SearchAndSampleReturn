...
## Recording Data
Some test data is in the folder called `test_dataset`.  In that folder you'll find a csv file with the output data for steering, throttle position etc. and the pathnames to the images recorded in each run.
Images in the folder called `calibration_images` can be used to do some of the initial calibration steps with.
